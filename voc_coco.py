...
# -*- coding: utf-8 -*-
"""
Created on Mon Oct 31 14:08:00 2022
...
if __name__ == '__main__':
 	# xml标注文件夹   
    xml_dir = '/media/ubuntu/logo_data/logo_detection/openlogo/openlogo/50class/train_label'
    # 训练数据的josn文件
    save_json_train = '/media/ubuntu/logo_data/logo_detection/openlogo/openlogo/50class/coco/train.json'
    # 验证数据的josn文件
    save_json_val = '/media/ubuntu/logo_data/logo_detection/openlogo/openlogo/50class/coco/val.json'
    # 验证数据的test文件
    save_json_test = '/media/ubuntu/logo_data/logo_detection/openlogo/openlogo/50class/coco/test.json'
    # 类别，如果是多个类别，往classes中添加类别名字即可，比如['dog', 'person', 'cat']
    with open('/media/ubuntu/logo_data/logo_detection/openlogo/openlogo/50class/name.txt') as f:
        class1 = f.readlines()
    classes = [x.strip() for i,x  in enumerate(class1)]
    print(classes)
